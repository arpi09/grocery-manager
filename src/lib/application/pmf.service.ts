...
import type { ActivationFunnelPeriodDays, ActivationFunnelSnapshot } from '$lib/domain/activation-funnel';
...
export class PmfService {
	...
	getActivationFunnelMetrics(
		...
		periodDays: ActivationFunnelPeriodDays = 7,

		now?: Date

	): Promise<ActivationFunnelSnapshot> {

		return this.repository.getActivationFunnelMetrics(periodDays, now);

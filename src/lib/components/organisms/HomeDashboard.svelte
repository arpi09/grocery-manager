<script lang="ts">
	...
	import HomeAttentionStack from '$lib/components/organisms/HomeAttentionStack.svelte';
	...
	const showRecommendsSection = $derived(
		summary.totalItems > 0 &&
			(householdBriefing.replenishment.length > 0 || receiptFootnoteCount > 0)
	);
...
<section class="home" aria-label={t('home.ariaLabel')}>
	...
	{#if summary.totalItems === 0}
		<section class="home-v3-section" aria-labelledby="home-attention-heading">
			<h2 id="home-attention-heading" class="home-v3-heading">{t('home.v3.attentionTitle')}</h2>
			<p class="attention-empty">{t('home.taglineEmpty')}</p>
		</section>

		<section class="home-v3-section" aria-labelledby="home-do-now-heading">
			<h2 id="home-do-now-heading" class="home-v3-heading">{t('home.v3.doNowTitle')}</h2>
			{#if canWrite}
				<EmptyState
					iconId="box"
	...
	{:else}
		...
		{#if showRecommendsSection}
			<section class="home-v3-section" aria-labelledby="home-recommends-heading">
				...
				{#if householdBriefing.replenishment.length > 0}
					<ReplenishmentSection
						suggestions={householdBriefing.replenishment}

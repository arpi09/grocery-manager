...
/** Assert OpenAI strict JSON schema shape (additionalProperties: false, required keys). */
export function assertStrictOpenAiSchema(schema: Record<string, unknown>, path = '$'): void {

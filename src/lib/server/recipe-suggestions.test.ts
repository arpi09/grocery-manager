...
import { parseRecipeSuggestions, RECIPE_SUGGESTIONS_SCHEMA } from './recipe-suggestions';

describe('RECIPE_SUGGESTIONS_SCHEMA', () => {
	it('lists every property as required for OpenAI strict json_schema', () => {
		assertStrictOpenAiSchema(RECIPE_SUGGESTIONS_SCHEMA);
	});
});

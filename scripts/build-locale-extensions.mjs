...
const extensions = {
	sv: {
		...
		shopping: {
			...
			assistantIntro:
				'AI analyserar ditt skafferi, utgångsdatum och måltidsplan — och föreslår varor till inköpslistan.',
	...
	en: {
		...
		shopping: {
			...
			assistantIntro:
				'AI analyses your pantry, expiry dates and meal plan — and suggests items for your shopping list.',

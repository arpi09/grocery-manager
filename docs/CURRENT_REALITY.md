...
| **Prod SHA** | `8efc9d33c` @ [28735052802](https://github.com/arpi09/grocery-manager/actions/runs/28735052802) (live, release 2026.7.5, deploy_tier=auto→fast, e2e critical grön; curl-smoke /, /guider, /login = 200, /planer = 302). **Declutter-batch:** Lager (#223) + Äta (#224). |
| **Master SHA** | `de0be3e1c` — declutter-batch: #223 Lager (färre konkurrerande CTA:er/sektion), #224 Äta (tvillingbanners ihopslagna, schemaform bakom disclosure). |

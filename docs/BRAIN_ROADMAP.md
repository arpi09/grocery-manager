...
**Baseline:** Prod `8d3862dc`, Brain V1 live (shelf/location/replenishment learning, Memory Explorer, Uppskattat i kvittoreview). **Release princip:** merge+deploy = aktiv, ingen flag-flip.
...
**Deploy bundle 2 (LAST):** Slice 1–3 + #52/#53 + optional V1.4 → “Brain syns i skafferiet och inköp.”

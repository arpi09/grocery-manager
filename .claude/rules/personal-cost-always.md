...
5. **Full policy:** [coordinator-personal-cost-mode.mdc](./coordinator-personal-cost-mode.mdc) (WIP caps, cadence, model policy) · [coordinator-spawn-budget.mdc](./coordinator-spawn-budget.mdc) (S/M/L/XL before spawn).
